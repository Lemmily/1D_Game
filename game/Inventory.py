...
class Inventory(object):
    ...
    def get(self, _type):
        if _type in self.contents and self.contents[_type] > 0:
...
class Item(object):
    def __init__(self, dict_, posi=(0, 0), **kwargs):
        self.sprite = render.SpriteTile(frames=R.SPRITE_CACHE[dict_["tilesheet"]], sprite_pos=dict_["tile"],
